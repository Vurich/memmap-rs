...
impl MmapInner {
    ...
    pub fn map_execute(len: usize, file: &File, offset: usize) -> io::Result<MmapInner> {
        MmapInner::new(Some(file),
                       winapi::PAGE_READONLY,
    ...
    pub fn anonymous(len: usize, _stack: bool) -> io::Result<MmapInner> {
    ...
    pub fn make_read_exec(&mut self) -> io::Result<()> {
